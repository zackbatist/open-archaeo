...
+ Matt Peeples / mcd / [PersonalSite](http://www.mattpeeples.net/mcd.html) - R Script for Calculating Mean Ceramic Dates and Estimating Error
+ Matt Peeples / BR / [PersonalSite](http://www.mattpeeples.net/BR.html) - R Script for Calculating the Brainerd-Robinson Coefficient of Similarity and Assessing Sampling Error
+ Matt Peeples / ca / [PersonalSite](http://www.mattpeeples.net/ca.html) - R Script for Seriation Using Correspondence Analysis
+ Matt Peeples / kmeans / [PersonalSite](http://www.mattpeeples.net/kmeans.html) - R Script for K-Means Cluster Analysis

### Other Scripts
+ tsdye / harris-matrix / [GitHub](https://github.com/tsdye/harris-matrix/) / [PersonalSite](http://tsdye.online/harris-matrix/homepage/) - Write Graphviz dot files for archaeological sequence diagrams and Bayesian chronological models
...
+ joeroe / fieldwalkr / [](https://github.com/joeroe/fieldwalkr) - Spatial Sampling and Survey Simulation Tools
+  / munsell / [CRAN](https://cran.r-project.org/web/packages/munsell/index.html) - Provides easy access to, and manipulation of, the Munsell colours
+ Matt Peeples /  / [PersonalSite](http://www.mattpeeples.net/caboot.html) - Additional instructions for running bootstrapped correspondence analysis R
...
+  / archdata / [CRAN](https://cran.rstudio.com/web/packages/archdata/index.html) - The archdata package provides several types of data that are typically used in archaeological research << CRAN

## Snippets
+ isaacullah / DroneSurveyPlanner / [GitHub](https://github.com/isaacullah/DroneSurveyPlanner) / [](PersonalSite) - This is a LibreOffice Calc spreadsheet designed to help you plan an aerial drone mapping survey mission
...
+ Matt Peeples / LISA / [PersonalSite](http://www.mattpeeples.net/modules/LISA.html) - Moran's I and Getis-Ord G* Analysis
+ Matt Peeples / PLC / [PersonalSite](http://www.mattpeeples.net/modules/PLC.html) - Cluster Analysis - Pure Locational Clustering
...
+ Matt Peeples / UnconstrainedClustering / [PersonalSite](http://www.mattpeeples.net/modules/UnconstrainedClustering.html) - Unconstrained Clustering
+ Matt Peeples / BasicMapping / [PersonalSite](http://www.mattpeeples.net/modules/BasicMapping.html) - Working with map data in R
+ Matt Peeples / PointPattern / [PersonalSite](http://www.mattpeeples.net/modules/PointPattern.html) - Point Pattern Analysis
...
+ isaacullah /  / [PersonalSite](http://isaacullah.github.io/A-mobile-field-data-collection-workflow/) - A Mobile Data-Collection Workflow for Archaeologists
...
+ FOSS4Arch /  / [GitHub](https://github.com/FOSS4Arch/SAA2016) - 
+ benmarwick /  / [GitHub](https://github.com/benmarwick/SAA2015-Open-Methods) - 
+ ISAAKiel /  / [GitHub](https://github.com/ISAAKiel/LAC2018_Session_44C) - 
+ ISAAKiel /  / [GitHub](https://github.com/ISAAKiel/SummerSchool_moin) - 
+ ISAAKiel /  / [GitHub](https://github.com/ISAAKiel/r_tutorial_caa_2018) - 
+ ISAAKiel /  / [GitHub](https://github.com/ISAAKiel/R-Tutorial_CAA2016) - 
+ ISAAKiel /  / [GitHub](https://github.com/ISAAKiel/Mosaic) - 
+ mpeeples2008 /  / [GitHub](https://github.com/mpeeples2008/Archaeological-Network-Uncertainty) - R Markdown document associated with the workshop at the Computer Applications and Quantitative Methods in Archaeology Meeting in Atlanta, GA 2017, hosted by Matt Peeples and Tom Brughmans. Network Science and Statistical Techniques for Dealing with Uncertainties in Archaeological Datasets. 
...
+  / @OpenAccessArch / [Twitter](https://twitter.com/OpenAccessArch) / [PersonalSite](http://www.openaccessarchaeology.org) - 
+ Keith Kintigh / Tools for Quantitative Archaeology / [PersonalSite](http://tfqa.com/) - Keith KintighTools for Quantitative Archaeology TFQA, is a package of more than 45 PC programs developed to satisfy several unusual analytical needs of archaeologists
+ isaacullah /  / [PersonalSite](http://isaacullah.github.io/List-of-FOSS-tools-for-academics/) - Isaac's List of FOSS tools for academics... and what to use them for!
...
### Palaeoclimatearchaeobotany stuff
